...
export function CopyToDashboardModal({ api, closeModal }: CopyToDashboardModalProps) {
  ...
  const dashboardId = api.parent.value.savedObjectId.value;

  const onSubmit = useCallback(() => {
    const dashboard = api.parent.value;
    const panelToCopy = dashboard.getDashboardPanelFromId(api.id.value);
