...
import { Container, PanelState } from '../../containers';
...
export const viewModeToSubject = (subscription: Subscription, embeddable: PanelEmbeddable) => {
...
interface DashboardRequiredMethods {
  replacePanel: (
    panelToReplace: PanelState<EmbeddableInput>,
    newPanel: PanelState<EmbeddableInput>,
...
export const hasDashboardRequiredMethods = (
  ...
  return (
    typeof (container as DashboardRequiredMethods).replacePanel === 'function' &&
